		...
		<TR>
			...
			<TD align="left" valign="top">
				<TABLE border="0" class="top" width="700">
					...
					<s:form action="queryTheme" namespace="/" method="post" id="form4" name="form4" theme="simple">
					<s:set value="{'全部'}" var="all"/>
					<s:hidden name="Flag" value="toquery"></s:hidden>
						...
						<TD>
							<TABLE align="center" border="0" width="90%">
								<TR>
									...
									<TD width="35%">										
										<s:textfield cssClass="box" name="theme.theId" size="20" maxLength="20" />
									</TD>
									<TD width="12%">	题目类型：
									</TD>
									<TD>										
				<s:select id="questionType" name="theme.tbThemeType.thetypeName" list="#all" onclick="getOption('questionType')">
				</s:select>	
									</TD>
								</TR>
								<TR>
									...
									<TD>
				<s:select id="questionArea" name="theme.tbThemeArea.theareaName" list="#all" onclick="getOption('questionArea')">
				</s:select>
									</TD>
									<TD>	题目难度：
									</TD>
				...
				<s:select id="questionDif" name="theme.tbThemeDifficulty.thedifName" list="#all" >
								...
								<TR>
									...
									<TD>
				                      <s:textfield cssClass="box" name="theme.tbUser.userName" size="20" maxLength="20" />
									</TD>
									<TD>	状态：
									</TD>
									<TD>
				<s:set value="{'全部','已保存','已提交','已通过','已拒绝','已撤销'}" var="value"/>										
				<s:select name="theme.tbStateflag.stateFlag" list="#value">
				</s:select>
									</TD>
								</TR>
								...
								<TR>
									...
									<TD colspan="3">	由：										
										<s:textfield name="theIndate1" id="theIndate1" cssClass="Wdate"  value='' onclick="WdatePicker()"/>&nbsp;
										&nbsp;&nbsp;&nbsp;&nbsp;到：										
										<s:textfield name="theIndate2" id="theIndate2" cssClass="Wdate"  value='' onclick="WdatePicker()"/>&nbsp;
									</TD>
								</TR>
								<TR>
									<TD height="20">
							...
							<TABLE align="center" border="0" class="ItemList" height="20" width="96%">
								<TR height="24" align="middle">
											...
											<TR align="middle" class="ItemBody">
												<TD class="ItemBody" height="20">	<a href='${pageContext.request.contextPath}/toDisplay.action?theme.themeId=${themeId}'><s:property value="theId"/></a>
												</TD>
												...
												<TD class="ItemBody">	<s:property value="tbStateflag.stateFlag"/>
												</TD>
											</TR>
											</s:iterator>
											<TR align="middle" class="ItemBody">
